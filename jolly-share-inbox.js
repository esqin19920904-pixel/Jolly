/* ==========================================================================
   JOLLY — jolly-share-inbox.js                v5.6.0   (2026-07-30)
   --------------------------------------------------------------------------
...
(function (global) {
  ...
  function diagHTML() {
    ...
    h.push('<div class="tools" style="margin-top:8px"><div class="t" data-dgfab="1">' +
           (dsRead('jolly_fab_off', 0) ? '🔎 Üzən axtarışı AÇ' : '🔎 Üzən axtarışı söndür') + '</div></div>');
    var bound = '';
  ...
  function lbind() {
    ...
    root.addEventListener('click', function (e) {
      ...
      if (t.closest && t.closest('[data-dgfab]')) {
        e.stopPropagation();
        var foff = dsRead('jolly_fab_off', 0);
        if (foff) { global.JollyQuickSearch.show(); toast('Üzən axtarış açıldı', 'ok'); }
  ...
  function qsFab() {
    ...
    if (dsRead('jolly_fab_off', 0)) return;
  ...
  global.JollyQuickSearch = {
    ...
    show: function () { dsWrite('jolly_fab_off', 0); qsFab(); },
