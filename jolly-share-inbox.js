/* ==========================================================================
   JOLLY — jolly-share-inbox.js                v5.4.0   (2026-07-30)
   --------------------------------------------------------------------------
...
(function (global) {
  ...
  function lsAttach() {
    if (!perm('search.live.use')) return lsDetach();
  ...
  var LSCSS = [
    ...
    '.ls-panel .whyx{font-size:11px;opacity:.5;margin-top:3px;color:#cfd3e0}',
  ...
  function dsPaint() {
    ...
    wrap.innerHTML = html + dsBuilderHTML();
