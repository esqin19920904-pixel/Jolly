...
(() => {
  ...
  */
  const LAZY = [
    /* ── 08-15 İDARƏ MƏRKƏZİ ────────────────────────────────
       Birinci sırada yüklənir ki, icazə süzgəci gec qalmasın.
       `lock: true` — Modul Təmizliyindən söndürülə bilməz,
       əks halda Esqin özünü idarə ekranından kilidləyərdi.
