...
(() => {
  ...
  */
  const LAZY = [
    /* ── 08-15/16 idarə qatı ─────────────────────────────────
       Birinci sırada yüklənir; `lock:true` — Modul Təmizliyindən
       söndürülə bilməz (özünü kilidləməmək üçün).
       index.html-ə TOXUNULMUR. */
    { key: 'jolly-cloud2.js',      src: 'jolly-cloud2.js',      label: 'Bulud körpüsü',    icon: '☁️', lock: true },
    { key: 'jolly-space.js',       src: 'jolly-space.js',       label: 'Yaddaş qoruyucusu', icon: '🧹', lock: true },
    { key: 'jolly-cc.js',          src: 'jolly-cc.js',          label: 'JOLLY AI Mərkəz',  icon: '🧠', lock: true },
    { key: 'jolly-dx.js',          src: 'jolly-dx.js',          label: 'Diaqnostika',      icon: '🩺', lock: true },
