...
(function (global) {
  ...
  function render() {
    ...
    h.push('<div class="dash-head"><div>' +
             ...
             '<div class="muted" style="font-size:12.5px;">v1.1 · ' + list.length + ' modul</div>' +
           '</div></div>');
  ...
  function watch() {
    ...
    if (!timer) timer = setInterval(function () { hookPerms(); sweep(); }, 1500);
  }
  ...
  global.addEventListener('hashchange', function () {
    setTimeout(function () { hookPerms(); guard(); sweep(); }, 60);
  });
